---
title: "京张共织：从遗产线到可验证AI公共空间"
author_github: "HanT1anZun"
language: "zh"
...
<!-- Participant note: this intake package uses the repository's explicitly provisional boundary because the public qualification package does not include a cleared official polygon. Replace the boundary and recalculate all dependent layers and metrics when the official attachment becomes available. -->
